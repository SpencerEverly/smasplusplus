...
local goalTapeSettings = {
    ...
    irisOutSFX = extrasounds.id[145], -- The sound used for the iris out. Can be nil for none, a number for a vanilla sound, or a sound effect object/string for a custom sound.
    ...
    countdownStartSFX = extrasounds.id[142],
    countdownLoopSFX  = extrasounds.id[143],
    countdownEndSFX   = extrasounds.id[144],
}
