...
function costume.onInit(p)
    extrasounds.sound.sfx[1] = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/player-jump.ogg")
    Audio.sounds[3].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/block-hit.ogg")
    extrasounds.sound.sfx[4] = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/block-smash.ogg")
    Audio.sounds[5].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/player-shrink.ogg")
    Audio.sounds[6].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/player-grow.ogg")
    Audio.sounds[7].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/mushroom.ogg")
    extrasounds.sound.sfx[8] = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/player-died.ogg")
    Audio.sounds[12].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/has-item.ogg")
    extrasounds.sound.sfx[14] = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/coin.ogg")
    extrasounds.sound.sfx[15] = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/1up.ogg")
    Audio.sounds[18].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/fireball.ogg")
    Audio.sounds[30].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/pause.ogg")
    Audio.sounds[32].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/pswitch.ogg")
    Audio.sounds[33].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/tail.ogg")
    --Audio.sounds[34].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/racoon.ogg")
    Audio.sounds[52].sfx = Audio.SfxOpen("costumes/mario/16-NSMBWii-Mario/got-star.ogg")
