...
function costume.onInit(p)
    if p.powerup == 1 then
        Audio.sounds[1].sfx  = Audio.SfxOpen("costumes/mario/8-SMBSpecial/player-jump-small.ogg")
    elseif p.powerup >= 2 then
        Audio.sounds[1].sfx  = Audio.SfxOpen("costumes/mario/8-SMBSpecial/player-jump.ogg")
    end
	Audio.sounds[2].sfx  = Audio.SfxOpen("costumes/mario/8-SMBSpecial/stomped.ogg")
	Audio.sounds[3].sfx  = Audio.SfxOpen("costumes/mario/8-SMBSpecial/block-hit.ogg")
	extrasounds.id[4]  = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/block-smash.ogg"))
	Audio.sounds[5].sfx  = Audio.SfxOpen("costumes/mario/8-SMBSpecial/player-shrink.ogg")
	Audio.sounds[6].sfx  = Audio.SfxOpen("costumes/mario/8-SMBSpecial/player-grow.ogg")
	extrasounds.id[7]  = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/mushroom.ogg"))
	extrasounds.id[8]  = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/player-died.ogg"))
	Audio.sounds[9].sfx  = Audio.SfxOpen("costumes/mario/8-SMBSpecial/shell-hit.ogg")
	Audio.sounds[10].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/player-slide.ogg")
	--Audio.sounds[11].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/item-dropped.ogg")
	--Audio.sounds[12].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/has-item.ogg")
	Audio.sounds[13].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/camera-change.ogg")
	extrasounds.id[14] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/coin.ogg"))
	extrasounds.id[15] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/1up.ogg"))
	Audio.sounds[16].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/lava.ogg")
	Audio.sounds[17].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/warp.ogg")
	extrasounds.id[18] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/fireball.ogg"))
	--Audio.sounds[19].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/level-win.ogg")
	--Audio.sounds[20].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/boss-beat.ogg")
	--Audio.sounds[21].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/dungeon-win.ogg")
	Audio.sounds[22].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/bullet-bill.ogg")
	Audio.sounds[23].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/grab.ogg")
	Audio.sounds[24].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/spring.ogg")
	Audio.sounds[25].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/hammer.ogg")
	Audio.sounds[29].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/do.ogg")
	Audio.sounds[31].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/key.ogg")
	Audio.sounds[32].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/pswitch.ogg")
	Audio.sounds[33].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/tail.ogg")
	Audio.sounds[34].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/racoon.ogg")
	Audio.sounds[35].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/boot.ogg")
	--extrasounds.id[36] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/smash.ogg"))
	Audio.sounds[37].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/thwomp.ogg")
	Audio.sounds[38].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/birdo-spit.ogg")
	extrasounds.id[39] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/birdo-hit.ogg"))
	Audio.sounds[41].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/birdo-beat.ogg")
	extrasounds.id[42] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/npc-fireball.ogg"))
	extrasounds.id[43] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/fireworks.ogg"))
	--Audio.sounds[44].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/bowser-killed.ogg")
	Audio.sounds[46].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/door.ogg")
	--Audio.sounds[47].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/message.ogg")
	Audio.sounds[48].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/yoshi.ogg")
	Audio.sounds[49].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/yoshi-hurt.ogg")
	--Audio.sounds[50].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/yoshi-tongue.ogg")
	Audio.sounds[51].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/yoshi-egg.ogg")
	Audio.sounds[52].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/got-star.ogg")
	Audio.sounds[54].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/player-died2.ogg")
	Audio.sounds[55].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/yoshi-swallow.ogg")
	Audio.sounds[57].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/dry-bones.ogg")
	Audio.sounds[58].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/smw-checkpoint.ogg")
	extrasounds.id[59] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/dragon-coin.ogg"))
	--Audio.sounds[61].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/smw-blaarg.ogg")
	--Audio.sounds[62].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/wart-bubble.ogg")
	--Audio.sounds[63].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/wart-die.ogg")
	Audio.sounds[71].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/climbing.ogg")
	Audio.sounds[72].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/swim.ogg")
	Audio.sounds[73].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/grab2.ogg")
	--Audio.sounds[74].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/saw.ogg")
	Audio.sounds[75].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/smb2-throw.ogg")
	Audio.sounds[76].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/smb2-hit.ogg")
	Audio.sounds[91].sfx = Audio.SfxOpen("costumes/mario/8-SMBSpecial/bubble.ogg")
	extrasounds.id[92] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/sprout-vine.ogg")) --Vine sprout
	extrasounds.id[93] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/iceball.ogg")) --Iceball
	extrasounds.id[96] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/2up.ogg")) --2UP
	extrasounds.id[97] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/3up.ogg")) --3UP
	extrasounds.id[98] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/5up.ogg")) --5UP
	extrasounds.id[99] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/dragon-coin-get2.ogg")) --Dragon Coin #2
	extrasounds.id[100] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/dragon-coin-get3.ogg")) --Dragon Coin #3
	extrasounds.id[101] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/dragon-coin-get4.ogg")) --Dragon Coin #4
	extrasounds.id[102] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/dragon-coin-get5.ogg")) --Dragon Coin #5
	extrasounds.id[103] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/cherry.ogg")) --Cherry
	extrasounds.id[104] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/explode.ogg")) --SMB2 Explosion
	extrasounds.id[105] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/8-SMBSpecial/hammerthrow.ogg")) --Player hammer throw
