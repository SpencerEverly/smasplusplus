...
function costume.onInit(p)
	...
	if not eventsRegistered then
		...
		extrasounds.id4  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/block-smash.ogg")
		...
		extrasounds.id7  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/mushroom.ogg")
		...
		extrasounds.id14 = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/coin.ogg")
		extrasounds.id15 = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/1up.ogg")
		...
		extrasounds.id18 = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/fireball.ogg")
		...
		extrasounds.id59 = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/dragon-coin.ogg")
