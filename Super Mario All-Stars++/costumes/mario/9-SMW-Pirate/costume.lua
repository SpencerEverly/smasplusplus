...
function costume.onInit(p)
	...
	if not eventsRegistered then
		...
		extrasounds.id[8]  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/player-died.ogg")
		...
		--extrasounds.id[36] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/9-SMW-Pirate/smash.ogg"))
		Audio.sounds[37].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/thwomp.ogg")
		extrasounds.id[42] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/9-SMW-Pirate/npc-fireball.ogg"))
