...
function costume.onTick()
	...
	Audio.sounds[4].sfx  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/block-smash.ogg")
	...
	Audio.sounds[7].sfx  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/mushroom.ogg")
	...
	Audio.sounds[14].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/coin.ogg")
	Audio.sounds[15].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/1up.ogg")
	...
	Audio.sounds[18].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/fireball.ogg")
	...
	Audio.sounds[59].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/dragon-coin.ogg")
