...
function costume.onInit(p)
	...
	if not eventsRegistered then
		...
		Audio.sounds[1].sfx  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/player-jump.ogg")
		Audio.sounds[2].sfx  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/stomped.ogg")
		Audio.sounds[3].sfx  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/block-hit.ogg")
		extrasounds.id[4]  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/block-smash.ogg")
		Audio.sounds[5].sfx  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/player-shrink.ogg")
		Audio.sounds[6].sfx  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/player-grow.ogg")
		extrasounds.id[7]  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/mushroom.ogg")
		Audio.sounds[8].sfx  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/player-died.ogg")
		Audio.sounds[9].sfx  = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/shell-hit.ogg")
		--Audio.sounds[10].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/player-slide.ogg")
		Audio.sounds[11].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/item-dropped.ogg")
		Audio.sounds[12].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/has-item.ogg")
		--Audio.sounds[13].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/camera-change.ogg")
		extrasounds.id[14] = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/coin.ogg")
		extrasounds.id[15] = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/1up.ogg")
		Audio.sounds[16].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/lava.ogg")
		Audio.sounds[17].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/warp.ogg")
		extrasounds.id[18] = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/fireball.ogg")
		--Audio.sounds[19].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/level-win.ogg")
		--Audio.sounds[20].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/boss-beat.ogg")
		--Audio.sounds[21].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/dungeon-win.ogg")
		Audio.sounds[22].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/bullet-bill.ogg")
		Audio.sounds[23].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/grab.ogg")
		Audio.sounds[24].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/spring.ogg")
		--Audio.sounds[25].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/hammer.ogg")
		Audio.sounds[29].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/do.ogg")
		Audio.sounds[31].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/key.ogg")
		Audio.sounds[32].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/pswitch.ogg")
		Audio.sounds[33].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/tail.ogg")
		Audio.sounds[34].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/racoon.ogg")
		--Audio.sounds[35].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/boot.ogg")
		--Audio.sounds[36].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/smash.ogg")
		Audio.sounds[37].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/thwomp.ogg")
		Audio.sounds[42].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/npc-fireball.ogg")
		Audio.sounds[43].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/fireworks.ogg")
		--Audio.sounds[44].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/bowser-killed.ogg")
		Audio.sounds[46].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/door.ogg")
		Audio.sounds[48].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/yoshi.ogg")
		Audio.sounds[49].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/yoshi-hurt.ogg")
		Audio.sounds[50].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/yoshi-tongue.ogg")
		Audio.sounds[51].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/yoshi-egg.ogg")
		Audio.sounds[52].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/got-star.ogg")
		Audio.sounds[54].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/player-died2.ogg")
		Audio.sounds[55].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/yoshi-swallow.ogg")
		Audio.sounds[56].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/ring.ogg")
		--Audio.sounds[57].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/dry-bones.ogg")
		Audio.sounds[58].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/smw-checkpoint.ogg")
		extrasounds.id[59] = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/dragon-coin.ogg")
		--Audio.sounds[61].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/smw-blaarg.ogg")
		--Audio.sounds[62].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/wart-bubble.ogg")
		--Audio.sounds[63].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/wart-die.ogg")
		Audio.sounds[71].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/climbing.ogg")
		Audio.sounds[72].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/swim.ogg")
		Audio.sounds[73].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/grab2.ogg")
		--Audio.sounds[74].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/saw.ogg")
		--Audio.sounds[75].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/smb2-throw.ogg")
		--Audio.sounds[76].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/smb2-hit.ogg")
		--Audio.sounds[91].sfx = Audio.SfxOpen("costumes/mario/9-SMW-Pirate/bubble.ogg")
...
function costume.onCleanup(p)
	...
	if costume.playerData[p] ~= nil then
		...
		extrasounds.id[4]3 = Audio.SfxOpen(Misc.resolveSoundFile("fireworks.ogg"))
