...
function costume.onInit(p)
    ...
    --extrasounds.sound.sfx[92] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/10-HotelMario/sprout-vine.ogg")) --Vine sprout
    extrasounds.sound.sfx[93] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/10-HotelMario/iceball.ogg")) --Iceball
    extrasounds.sound.sfx[96] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/10-HotelMario/2up.ogg")) --2UP
    extrasounds.sound.sfx[97] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/10-HotelMario/3up.ogg")) --3UP
    extrasounds.sound.sfx[98] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/10-HotelMario/5up.ogg")) --5UP
    --extrasounds.sound.sfx[99] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/10-HotelMario/dragon-coin-get2.ogg")) --Dragon Coin #2
    --extrasounds.sound.sfx[100] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/10-HotelMario/dragon-coin-get3.ogg")) --Dragon Coin #3
