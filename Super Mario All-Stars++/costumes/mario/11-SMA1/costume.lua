...
function costume.onTick() --WIP
	Audio.sounds[1].sfx  = Audio.SfxOpen("costumes/mario/11-SMA1/player-jump.ogg")
	...
	Audio.sounds[4].sfx  = Audio.SfxOpen("costumes/mario/11-SMA1/block-smash.ogg")
	...
	Audio.sounds[7].sfx  = Audio.SfxOpen("costumes/mario/11-SMA1/mushroom.ogg")
	Audio.sounds[8].sfx  = Audio.SfxOpen("costumes/mario/11-SMA1/player-died.ogg")
	Audio.sounds[9].sfx  = Audio.SfxOpen("costumes/mario/11-SMA1/shell-hit.ogg")
	Audio.sounds[10].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/player-slide.ogg")
	...
	Audio.sounds[14].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/coin.ogg")
	Audio.sounds[15].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/1up.ogg")
	...
	Audio.sounds[18].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/fireball.ogg")
	...
	Audio.sounds[33].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/tail.ogg")
	...
	Audio.sounds[36].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/smash.ogg")
	...
	Audio.sounds[39].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/birdo-hit.ogg")
	Audio.sounds[40].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/smb2-exit.ogg")
	Audio.sounds[41].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/birdo-beat.ogg")
	Audio.sounds[42].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/npc-fireball.ogg")
	Audio.sounds[43].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/fireworks.ogg")
	...
	Audio.sounds[59].sfx = Audio.SfxOpen("costumes/mario/11-SMA1/dragon-coin.ogg")
