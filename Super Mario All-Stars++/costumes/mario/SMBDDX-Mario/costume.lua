...
function costume.onInit(p)
	...
	--extrasounds.id[36] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/SMBDDX-Mario/smash.ogg"))
	...
	--extrasounds.id[39] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/SMBDDX-Mario/birdo-hit.ogg")
	--Audio.sounds[41].sfx = Audio.SfxOpen("costumes/mario/SMBDDX-Mario/birdo-beat.ogg")
	--extrasounds.id[42] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/SMBDDX-Mario/npc-fireball.ogg"))
