...
function costume.onInit(p)
	...
	if not eventsRegistered then
		...
		extrasounds.id4  = Audio.SfxOpen("costumes/mario/12-SMA2/block-smash.ogg")
		...
		extrasounds.id7  = Audio.SfxOpen("costumes/mario/12-SMA2/mushroom.ogg")
		...
		extrasounds.id14 = Audio.SfxOpen("costumes/mario/12-SMA2/coin.ogg")
		extrasounds.id15 = Audio.SfxOpen("costumes/mario/12-SMA2/1up.ogg")
		...
		extrasounds.id18 = Audio.SfxOpen("costumes/mario/12-SMA2/fireball.ogg")
		...
		extrasounds.id59 = Audio.SfxOpen("costumes/mario/12-SMA2/dragon-coin.ogg")
