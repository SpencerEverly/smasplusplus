...
function costume.onInit(p)
	...
	if not eventsRegistered then
		...
		extrasounds.id[4]  = Audio.SfxOpen("costumes/mario/12-SMA2/block-smash.ogg")
		...
		extrasounds.id[7]  = Audio.SfxOpen("costumes/mario/12-SMA2/mushroom.ogg")
		...
		extrasounds.id[14] = Audio.SfxOpen("costumes/mario/12-SMA2/coin.ogg")
		extrasounds.id[15] = Audio.SfxOpen("costumes/mario/12-SMA2/1up.ogg")
		...
		extrasounds.id[18] = Audio.SfxOpen("costumes/mario/12-SMA2/fireball.ogg")
		...
		Audio.sounds[42].sfx = Audio.SfxOpen("costumes/mario/12-SMA2/npc-fireball.ogg")
		Audio.sounds[43].sfx = Audio.SfxOpen("costumes/mario/12-SMA2/fireworks.ogg")
		...
		Audio.sounds[52].sfx = Audio.SfxOpen("costumes/mario/12-SMA2/got-star.ogg")
		...
		extrasounds.id[59] = Audio.SfxOpen("costumes/mario/12-SMA2/dragon-coin.ogg")
...
function costume.onTickEnd()
	...
	--	if(not powerdown) then --This happens if player is hurt when on 1HP, so should die.
	--		killed = true;
