...
function costume.onInit(p)
	...
	extrasounds.id[4]  = Audio.SfxOpen("costumes/mario/PrincessRescue/block-smash.ogg")
	...
	extrasounds.id[15] = Audio.SfxOpen("costumes/mario/PrincessRescue/1up.ogg")
	Audio.sounds[17].sfx = Audio.SfxOpen("costumes/mario/PrincessRescue/warp.ogg")
	extrasounds.id[18]  = Audio.SfxOpen("costumes/mario/PrincessRescue/fireball.ogg")
	...
	extrasounds.id[42] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/PrincessRescue/npc-fireball.ogg"))
	extrasounds.id[43] = Audio.SfxOpen("costumes/mario/PrincessRescue/fireworks.ogg")
