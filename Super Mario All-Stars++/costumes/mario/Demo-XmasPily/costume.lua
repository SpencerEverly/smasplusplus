...
local function shootFireball(args)
	...
	if  args.playSound ~= false  then
		SFX.play(args.sound  or  pDat.pily.customSounds.fireball  or  "sound/fireball.ogg")
	end
...
function costume.onInit(playerObj, pDat)
	...
	extrasounds.id[4]  = Audio.SfxOpen("costumes/mario/Demo-XmasPily/block-smash.ogg")
	...
	extrasounds.id[7]  = Audio.SfxOpen("costumes/mario/Demo-XmasPily/mushroom.ogg")
	extrasounds.id[8]  = Audio.SfxOpen("costumes/mario/Demo-XmasPily/player-died.ogg")
	...
	extrasounds.id[14] = Audio.SfxOpen("costumes/mario/Demo-XmasPily/coin.ogg")
	extrasounds.id[15] = Audio.SfxOpen("costumes/mario/Demo-XmasPily/1up.ogg")
	...
	extrasounds.id[18] = Audio.SfxOpen("costumes/mario/Demo-XmasPily/fireball.ogg")
	...
	extrasounds.id[59] = Audio.SfxOpen("costumes/mario/Demo-XmasPily/dragon-coin.ogg")
