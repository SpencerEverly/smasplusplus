		...
		pDat.shootFireball = function(self, args)
			...
			if  args == nil  then
				...
				if  self.powerup == 3 then
					-- Aiming upward
					if  p.keys.up == KEYS_DOWN  then
						args.speed = vector(5,-7)
					elseif p.keys.down == KEYS_DOWN and not p:isOnGround() then
...
local inputEvent = function(playerData, p)
	...
	if  playerData.powerup == 6 and (not isFairy)  then
	...
	if  p.keys.run == KEYS_UNPRESSED  or  p.keys.run == KEYS_UP  then
...
function costume.onInit(playerObj, pDat)
	...
	extrasounds.id[4]  = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/block-smash.ogg"))
	...
	extrasounds.id[7]  = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/mushroom.ogg"))
	extrasounds.id[8]  = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/player-died.ogg"))
	...
	extrasounds.id[14] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/coin.ogg"))
	extrasounds.id[15] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/1up.ogg"))
	...
	extrasounds.id[18] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/fireball.ogg"))
	...
	--extrasounds.id[36] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/smash.ogg"))
	...
	extrasounds.id[39] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/birdo-hit.ogg"))
	Audio.sounds[41].sfx = Audio.SfxOpen("costumes/mario/Demo-XmasPily/birdo-beat.ogg")
	--extrasounds.id[42] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/npc-fireball.ogg"))
	--extrasounds.id[43] = Audio.SfxOpen("costumes/mario/Demo-XmasPily/fireworks.ogg")
	...
	extrasounds.id[59] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/dragon-coin.ogg"))
	...
	extrasounds.id[92] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/vine-sprout.ogg"))
	extrasounds.id[93] = Audio.SfxOpen(Misc.resolveSoundFile("costumes/mario/Demo-XmasPily/iceball.ogg"))
...
function costume.onCleanup(playerObj, p)
	...
	extrasounds.id[92] = Audio.SfxOpen(Misc.resolveSoundFile("sprout-vine.ogg"))
	extrasounds.id[93] = Audio.SfxOpen(Misc.resolveSoundFile("iceball.ogg"))
	extrasounds.id[94] = Audio.SfxOpen(Misc.resolveSoundFile("yi-freeze.ogg"))
	extrasounds.id[95] = Audio.SfxOpen(Misc.resolveSoundFile("yi-icebreak.ogg"))
	extrasounds.id[96] = Audio.SfxOpen(Misc.resolveSoundFile("2up.ogg"))
	extrasounds.id[97] = Audio.SfxOpen(Misc.resolveSoundFile("3up.ogg"))
	extrasounds.id[98] = Audio.SfxOpen(Misc.resolveSoundFile("5up.ogg"))
	extrasounds.id[99] = Audio.SfxOpen(Misc.resolveSoundFile("dragon-coin-get2.ogg"))
	extrasounds.id[100] = Audio.SfxOpen(Misc.resolveSoundFile("dragon-coin-get3.ogg"))
	extrasounds.id[101] = Audio.SfxOpen(Misc.resolveSoundFile("dragon-coin-get4.ogg"))
	extrasounds.id[102] = Audio.SfxOpen(Misc.resolveSoundFile("dragon-coin-get5.ogg"))
	extrasounds.id[103] = Audio.SfxOpen(Misc.resolveSoundFile("cherry.ogg"))
