...
function costume.onInit(playerObj, pDat)
	...
	extrasounds.id4  = Audio.SfxOpen("costumes/mario/Demo-XmasPily/block-smash.ogg")
	...
	extrasounds.id7  = Audio.SfxOpen("costumes/mario/Demo-XmasPily/mushroom.ogg")
	...
	extrasounds.id14 = Audio.SfxOpen("costumes/mario/Demo-XmasPily/coin.ogg")
	extrasounds.id15 = Audio.SfxOpen("costumes/mario/Demo-XmasPily/1up.ogg")
	...
	extrasounds.id18 = Audio.SfxOpen("costumes/mario/Demo-XmasPily/fireball.ogg")
	...
	extrasounds.id59 = Audio.SfxOpen("costumes/mario/Demo-XmasPily/dragon-coin.ogg")
