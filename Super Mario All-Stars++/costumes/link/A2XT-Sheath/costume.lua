...
--function costume.onStart()
  --Audio.playSFX("costumes/link/A2XT-Sheath/link-letsago.ogg")
...
function costume.onTick() --WIP
	Audio.sounds[1].sfx  = Audio.SfxOpen("costumes/link/A2XT-Sheath/player-jump.ogg")
	...
	Audio.sounds[4].sfx  = Audio.SfxOpen("costumes/link/A2XT-Sheath/block-smash.ogg")
	...
	Audio.sounds[7].sfx  = Audio.SfxOpen("costumes/link/A2XT-Sheath/mushroom.ogg")
	Audio.sounds[8].sfx  = Audio.SfxOpen("costumes/link/A2XT-Sheath/player-died.ogg")
	Audio.sounds[9].sfx  = Audio.SfxOpen("costumes/link/A2XT-Sheath/shell-hit.ogg")
	Audio.sounds[10].sfx = Audio.SfxOpen("costumes/link/A2XT-Sheath/player-slide.ogg")
	...
	Audio.sounds[14].sfx = Audio.SfxOpen("costumes/link/A2XT-Sheath/coin.ogg")
	Audio.sounds[15].sfx = Audio.SfxOpen("costumes/link/A2XT-Sheath/1up.ogg")
	...
	Audio.sounds[18].sfx = Audio.SfxOpen("costumes/link/A2XT-Sheath/fireball.ogg")
	...
	Audio.sounds[33].sfx = Audio.SfxOpen("costumes/link/A2XT-Sheath/tail.ogg")
	...
	Audio.sounds[36].sfx = Audio.SfxOpen("costumes/link/A2XT-Sheath/smash.ogg")
	Audio.sounds[37].sfx = Audio.SfxOpen("costumes/link/A2XT-Sheath/thwomp.ogg")
	Audio.sounds[42].sfx = Audio.SfxOpen("costumes/link/A2XT-Sheath/npc-fireball.ogg")
	Audio.sounds[43].sfx = Audio.SfxOpen("costumes/link/A2XT-Sheath/fireworks.ogg")
	...
	Audio.sounds[59].sfx = Audio.SfxOpen("costumes/link/A2XT-Sheath/dragon-coin.ogg")
