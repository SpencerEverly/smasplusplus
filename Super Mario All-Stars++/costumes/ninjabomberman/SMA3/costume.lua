...
function costume.onInit(p)
	...
	extrasounds.id[4]  = Audio.SfxOpen("costumes/ninjabomberman/SMA3/SFX/block-smash.ogg")
	...
	extrasounds.id[7]  = Audio.SfxOpen("costumes/ninjabomberman/SMA3/SFX/mushroom.ogg")
	...
	extrasounds.id[15] = Audio.SfxOpen("costumes/ninjabomberman/SMA3/SFX/1up.ogg")
	...
	extrasounds.id[18] = Audio.SfxOpen("costumes/ninjabomberman/SMA3/SFX/fireball.ogg")
	...
	extrasounds.id[4]3 = Audio.SfxOpen("costumes/ninjabomberman/SMA3/SFX/fireworks.ogg")
	...
	extrasounds.id[59] = Audio.SfxOpen("costumes/ninjabomberman/SMA3/SFX/dragon-coin.ogg")
