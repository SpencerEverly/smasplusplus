...
local umbrellR = Graphics.loadImageResolved("costumes/toad/Juni/UmbrellaR.png")
local umbrLa =  Graphics.loadImageResolved("costumes/toad/Juni/UmbrellaL.png")
local holographic = Graphics.loadImageResolved("costumes/toad/Juni/Holoplayer_0_stopped_1.png")
local holostart = false
local junistarted = 0

local hologram = Audio.SfxOpen("sound/character/junisfx/HologramA.ogg");
local sfx_doublejump = Audio.SfxOpen("sound/character/junisfx/KnyttDoubleJump.ogg");
local jumpsfx = Audio.SfxOpen("sound/character/junisfx/KnyttJump.ogg");
local land = Audio.SfxOpen("sound/character/junisfx/KnyttLand.ogg");
local savepoint = Audio.SfxOpen("sound/character/junisfx/Savepoint.ogg");
local umbrellaa = Audio.SfxOpen("sound/character/junisfx/UmbrellaA.ogg");
local umbrellab = Audio.SfxOpen("sound/character/junisfx/UmbrellaB.ogg");
