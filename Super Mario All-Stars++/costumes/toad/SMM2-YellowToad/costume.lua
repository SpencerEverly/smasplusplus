...
costume.SMM2Settings = {
	...
	powerStarJingleLength = 70, --The length of time your character will wait before posing during the Power Star victory animation. Default: 70
...
function costume.onInit(p)
	...
	if not eventsRegistered then
		...
		Audio.sounds[30].sfx = Audio.SfxOpen("costumes/luigi/SMM2-YellowToad/pause.ogg")
		Audio.sounds[52].sfx = Audio.SfxOpen("costumes/luigi/SMM2-YellowToad/got-star.ogg")
