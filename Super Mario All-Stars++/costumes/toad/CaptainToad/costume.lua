--[[
    ...
    SMW-styled Captain Toad (Playable Costume)
    by FutureNyanCat aka. Hexelectron

    Toad  sprites by: Nintendo, GlacialSiren484, MauricioN64, Jamestendo64, LinkStormZ
    Original SMW Toad Costume by: MrDoubleA
    SMW-styled Captain Toad by: Askywalker (The Spriters Resource)
    Extra poses and powerups edited by: FutureNyanCat (Hexelectron)
    Ported to SMBX2 by: FutureNyanCat (Hexelectron)
    Player Sprite Mirrorer Plugin by: Enjl (Used for making the spritesheets)
    ...
    SMW-styled Captain Toad: https://www.spriters-resource.com/custom_edited/mariocustoms/sheet/138004/
