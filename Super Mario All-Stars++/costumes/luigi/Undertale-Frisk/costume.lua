...
function costume.onInit(p)
    extrasounds.sound.sfx[1] = Audio.SfxOpen("costumes/luigi/Undertale-Frisk/player-jump.ogg")
    ...
    extrasounds.sound.sfx[8]  = Audio.SfxOpen("costumes/luigi/Undertale-Frisk/player-died.ogg")
    ...
    extrasounds.sound.sfx[14] = Audio.SfxOpen("costumes/luigi/Undertale-Frisk/coin.ogg")
    extrasounds.sound.sfx[15] = Audio.SfxOpen("costumes/luigi/Undertale-Frisk/1up.ogg")
    ...
    --extrasounds.sound.sfx[43] = Audio.SfxOpen("costumes/luigi/Undertale-Frisk/fireworks.ogg")
