...
function costume.onInit(p)
	...
	Audio.sounds[8].sfx  = Audio.SfxOpen("costumes/luigi/17-NSMBDS-SMBX/player-died.ogg")
	...
	--Audio.sounds[43].sfx = Audio.SfxOpen("costumes/luigi/17-NSMBDS-SMBX/fireworks.ogg")
