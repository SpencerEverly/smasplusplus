...
function datetime.onDraw()
	if datetime.bottomright then
		Graphics.drawBox{x=719, y=575, width=76, height=20, color=Color.black..0.2, priority=0}
		textplus.print{x=724, y=580, text = "Time - ", priority=0, color=Color.white} --What time is it...!?
		...
		Graphics.drawBox{x=695, y=552, width=100, height=20, color=Color.black..0.2, priority=0}
		textplus.print{x=700, y=557, text = "Date - ", priority=0, color=Color.white} --What's the day, sir?!
	...
	if datetime.topright then
		Graphics.drawBox{x=719, y=5, width=76, height=20, color=Color.black..0.2, priority=0}
		textplus.print{x=724, y=10, text = "Time - ", priority=0, color=Color.white} --What time is it...!?
		...
		Graphics.drawBox{x=695, y=27, width=100, height=20, color=Color.black..0.2, priority=0}
		textplus.print{x=700, y=32, text = "Date - ", priority=0, color=Color.white} --What's the day, sir?!
