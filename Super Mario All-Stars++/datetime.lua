...
function datetime.onDraw()
	...
	if datetime.topright then
		if SaveData.resolution == "widescreen" then
			Graphics.drawBox{x=719, y=113, width=76, height=20, color=Color.black..0.2, priority=8}
			textplus.print{x=724, y=118, text = "Time - ", priority=8, color=Color.white} --What time is it...!?
			textplus.print{x=755, y=118, text = os.date("%I"), priority=8, color=Color.white}
			textplus.print{x=765, y=118, text = ":", priority=8, color=Color.white}
			textplus.print{x=768, y=118, text = os.date("%M"), priority=8, color=Color.white}
			textplus.print{x=780, y=118, text = os.date("%p"), priority=8, color=Color.white}
