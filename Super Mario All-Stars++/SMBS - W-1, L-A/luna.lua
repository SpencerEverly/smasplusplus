...
function onEvent(eventName)
	...
	if eventName == "Boss Begin" then
		Audio.MusicChange(1, "_OST/Super Smash Bros. Ultimate/Mario/aa20_skt_dragonboss.ogg")
	end
	if eventName == "Boss End" then
		Audio.MusicChange(1, "_OST/Super Mario Bros Spencer/Gravity ~ 8g_crim.xm")
	end
...
function onTick()
	...
	if currentCostume == "1-SMB1-RETRO" then
		...
		Audio.MusicChange(3, "_OST/Super Mario Bros Spencer/Gravity ~ 8g_crim.xm")
	end
end