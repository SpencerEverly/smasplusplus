...
function onTick()
	...
	if currentCostume == nil then
		Audio.MusicChange(0, "_OST/Super Mario Bros/Snow.spc|0;g=2.5")
	...
	if currentCostume == "1-SMB1-RETRO" then
		Audio.MusicChange(0, "_OST/Super Mario Bros (NES)/Snow.ogg")
	...
	if currentCostume == "4-SMB2-RETRO" then
		Audio.MusicChange(0, "_OST/Super Mario Bros 2 (NES)/Desert.ogg") --wip
	end
	...
	if currentCostume == "6-SMB3-RETRO" then
		Audio.MusicChange(0, "_OST/Super Mario Bros. 3 (NES)/Snow.ogg")
	...
	if currentCostume == "A2XT-DEMO" then
		Audio.MusicChange(0, "_OST/Adventures of Demo/ice_path.it")
