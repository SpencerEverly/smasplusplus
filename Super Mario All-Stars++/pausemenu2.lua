    ...
    if pauseplus.currentSubmenu then
        if not isOverworld then
            ...
            if SaveData.playerPfp == nil then
                sprite.draw{texture = File.loadImg("pfp/pfp.png"), width = 70, height = 70, x = 20, y = 490, priority = -1.7}
            elseif SaveData.playerPfp then
                sprite.draw{texture = File.loadImg("___MainUserDirectory/"..SaveData.playerPfp..""), width = 70, height = 70, x = 20, y = 490, priority = -1.7}
