...
function aw.registerAllPlayersDefault()
    ...
    aw.registerCharacter(CHARACTER_MEGAMAN, aw.createFrameTable(-5, -5, -5, -5, -5, -5, -5), {allowSpinjump = false})
    aw.registerCharacter(CHARACTER_WARIO, aw.createFrameTable(-4, -6, -6, -6, -6, -6, -6))
