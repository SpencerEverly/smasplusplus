	...
	--makes sure that you don't go over the limit of items
		...
		if furyinventory.activatefuryinventory == true then
			if furyinventory.furyinventoryopened == true then
				...
				if SaveData.resolution == "nes" then
					Graphics.drawImageWP(furyinventoryimg, 90, 488, -1.8)
					Graphics.drawImageWP(selector, selectx, selecty, -1.9)
					if SaveData.furyinventory.shroom == 0 then
				...
				if SaveData.resolution == "iphone1st" then
					Graphics.drawImageWP(furyinventoryimg, 190, 508, -1.8)
					Graphics.drawImageWP(selector, selectx, selecty, -1.9)
					if SaveData.furyinventory.shroom == 0 then
...
function furyinventory.onTick()
	...
	if furyinventory.hidden == false then
		...
		if SaveData.resolution == "nes" then
			Graphics.drawImageWP(furyinventorysmol, 92, 518, -1.86) -- draws the furyinventory
		...
		if SaveData.resolution == "iphone1st" then
			Graphics.drawImageWP(furyinventorysmol, 202, 538, -1.86) -- draws the furyinventory
