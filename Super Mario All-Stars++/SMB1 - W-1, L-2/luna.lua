...
function onExit()
	...
	if player:mem(0x15E, FIELD_WORD) == 6 and player.forcedState == FORCEDSTATE_INVISIBLE then --SMB1 World 3
		SaveData.smwMap.playerX = -195776
		SaveData.smwMap.playerY = -199072
	end
	if player:mem(0x15E, FIELD_WORD) == 7 and player.forcedState == FORCEDSTATE_INVISIBLE then --SMB1 World 4
