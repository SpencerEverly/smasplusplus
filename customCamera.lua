...
customCamera.useOriginalTargetsSystem = true
...
customCamera.targetOffsetX = 0
customCamera.targetOffsetY = 0
...
function customCamera.onTick()
    ...
    if targetsAreDifferent(customCamera.currentTargets,newTargets) then
        customCamera.previousTargetsFous = vector(camera.x + camera.width*0.5 - customCamera.targetOffsetX,camera.y + camera.height*0.5 - customCamera.targetOffsetY)
